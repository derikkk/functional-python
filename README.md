# Functional Python [![](https://github.com/derikkk/functional-python/workflows/tests/badge.svg)](https://github.com/derikkk/functional-python/actions?query=workflow%3Atests)
